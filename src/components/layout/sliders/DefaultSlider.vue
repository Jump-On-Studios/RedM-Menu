<template>
  <template v-if="props.slider.values.length > 1">
    <div :data-slider-index="props.index" class="slider">
      ...
      <div class="arrows">
        <div class="arrow left clicker" @click="sliderLeft(props.index)"><img src="/assets/images/menu/selection_arrow_left.png"></div>
        <div class="text hapna">{{ numItem() }}</div>
        <div class="arrow right clicker" @click="sliderRight(props.index)"><img src="/assets/images/menu/selection_arrow_right.png"></div>
      </div>
      <div class="boxes">
